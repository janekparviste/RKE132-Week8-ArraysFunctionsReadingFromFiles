string folderPath = @"C:\Users\Kasutaja\Documents\RKE129\Data";
...
int villainStrikesStrength = villainHP;
Console.WriteLine($"Today {villain} ({villainHP} HP) with {villainWeapon} tries to take over the world!");

while (heroHP > 0 && villainHP > 0)
{
    heroHP = heroHP - Hit(villain, villainStrikesStrength);
    villainHP = villainHP - Hit(hero, heroStrikesStrength);
}
